<template>
    <div id="ddxinxi">
	    ...
	    <div class="snav">
        	<div >
        		<span></span>
        		<p><span class="iconfont icon-dizhi"></span><strong>订单信息</strong></p>
        		<span></span>
        	</div>
        	<div class="ddxx">
        		<span></span>
        		<p><span class="iconfont icon-dizhi"></span><strong>历史订单</strong></p>
        		<span></span>
  ...
  <!-- Add "scoped" attribute to limit CSS to this component only -->
	...
	.lsdd-pic{width: 30%;height: 100%;position: relative;}
	.lsdd-pic>img{position: absolute;left: 0;right: 0;top: 0;bottom: 0;margin: auto;}
	.lsdd-xx{width: 70%;height: 100%;display: flex;}
